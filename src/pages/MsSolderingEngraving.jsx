    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: 12 }}>
                  ...
                  <div style={{ margin: '8px 0 6px 0', borderBottom: '1px dashed #000' }} />
                ...
                <table style={{ width: '100%', fontSize: 11, borderCollapse: 'collapse', marginBottom: 8 }}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style={{ paddingY: 3, color: '#444' }}>GST (5%)</td>
                ...
                <div style={{ borderBottom: '1px dashed #000', marginTop: 10, marginBottom: 10 }} />

                <div style={{ textAlign: 'center', fontSize: 9 }}>
                  <p style={{ margin: '2px 0', fontWeight: 'bold' }}>Thank you! Visit again!</p>
                  <p style={{ margin: '2px 0', color: '#666' }}>M.S. Gold Jewellery ERP</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {previewJob && (
        <div className="thermal-receipt-print" style={{ display: 'none' }}>
          ...
          <div style={{ borderBottom: '1px dashed #000', marginTop: 6, marginBottom: 8 }} />
