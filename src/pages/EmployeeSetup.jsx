                                        ...
                                        {editShift?.empId === emp.id ? (
                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                                ...
                                                <input type="time" value={editShift.shiftEnd}
                                                    ...
                                                    className="form-input" style={{ padding: '4px 8px', fontSize: 12, width: 100 }} />
                                                <button onClick={saveShift} style={{ padding: '4px 10px', borderRadius: 6, fontSize: 12, fontWeight: 700, background: 'linear-gradient(135deg,#fbbf24,#d97706)', border: 'none', cursor: 'pointer', color: '#000' }}>✓</button>
